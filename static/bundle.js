    ...
    render: function () {
        ...
        if (this.props.users) {
            userList = this.props.users.map(function (user, i) {
                return(
                    React.createElement("li", {key: i}, React.createElement("img", {src: "https://twitter.com/" + user + "/profile_image", className: "user_profile-pic"}), user, " ", React.createElement("img", {className: "connection_icon", 
                                                                                                                                       src: "data:image/png;base64,"}), " ")
                )
            })
        }
